...
if (i_stor==0):
   ...
   vy_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   vycp_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   vydd_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   vyce_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   vycb_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   v2_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   v2cd_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   v2dd_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   v2ce_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   v2cb_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   fnix_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   fniy_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,nisp),"d")
   ...
   fngx_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,ngsp),"d")
   fngy_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,ngsp),"d")
   psorg_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,ngsp),"d")
   psorcxg_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,ngsp),"d")
   psorrg_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1,ngsp),"d")
   feex_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   feey_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   feix_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   feiy_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   phi_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqx_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqp_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqxb_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqy_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqya_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqyb_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqym_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   fqyd_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   prad_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
   pradhyd_stor = np.zeros((bbb.n_stor,nx+1+1,ny+1+1),"d")
...
neq=bbb.neq
svrpkg=bbb.svrpkg.tobytes().strip()
#
bbb.ylodt = bbb.yl
...
##       Store variables if a storage time has been crossed
            if (bbb.dt_tot >= dt_stor*i_stor and i_stor<=bbb.n_stor):
               ...
               vy_stor[i_stor1,:,:,:] = bbb.vy
               vycp_stor[i_stor1,:,:,:] = bbb.vycp
               vydd_stor[i_stor1,:,:,:] = bbb.vydd
               vyce_stor[i_stor1,:,:,:] = bbb.vyce
               vycb_stor[i_stor1,:,:,:] = bbb.vycb
               v2_stor[i_stor1,:,:,:] = bbb.v2
               v2cd_stor[i_stor1,:,:,:] = bbb.v2cd
               v2dd_stor[i_stor1,:,:,:] = bbb.v2dd
               v2ce_stor[i_stor1,:,:,:] = bbb.v2ce
               v2cb_stor[i_stor1,:,:,:] = bbb.v2cb
               fnix_stor[i_stor1,:,:,:] = bbb.fnix
               fniy_stor[i_stor1,:,:,:] = bbb.fniy
               te_stor[i_stor1,:,:] = bbb.te
               ti_stor[i_stor1,:,:] = bbb.ti
               ng_stor[i_stor1,:,:,:] = bbb.ng
               fngx_stor[i_stor1,:,:,:] = bbb.fngx
               fngy_stor[i_stor1,:,:,:] = bbb.fngy
               psorg_stor[i_stor1,:,:,:] = bbb.psorg
               psorcxg_stor[i_stor1,:,:,:] = bbb.psorcxg
               psorrg_stor[i_stor1,:,:,:] = bbb.psorrg
               feex_stor[i_stor1,:,:] = bbb.feex
               feey_stor[i_stor1,:,:] = bbb.feey
               feix_stor[i_stor1,:,:] = bbb.feix
               feiy_stor[i_stor1,:,:] = bbb.feiy
               phi_stor[i_stor1,:,:] = bbb.phi
               fqx_stor[i_stor1,:,:] = bbb.fqx
               fqp_stor[i_stor1,:,:] = bbb.fqp
               fqxb_stor[i_stor1,:,:] = bbb.fqxb
               fqy_stor[i_stor1,:,:] = bbb.fqy
               fqya_stor[i_stor1,:,:] = bbb.fqya
               fqyb_stor[i_stor1,:,:] = bbb.fqyb
               fqym_stor[i_stor1,:,:] = bbb.fqym
               fqyd_stor[i_stor1,:,:] = bbb.fqyd
               prad_stor[i_stor1,:,:] = bbb.prad
               pradhyd_stor[i_stor1,:,:] = bbb.pradhyd
