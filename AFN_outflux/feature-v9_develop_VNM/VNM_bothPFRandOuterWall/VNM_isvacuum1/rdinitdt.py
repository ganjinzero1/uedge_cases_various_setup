...
bbb.itermxrdc = 14	    # value of itermx used by rdcontdt
...
bbb.tstor_e = 0.3		# ending time for storing solution
bbb.n_stor = 1000		    # number of linearly spaced storage points
