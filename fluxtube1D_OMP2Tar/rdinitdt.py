...
bbb.mult_dt = 2.4		# factor expanding dtreal after ii2max steps
bbb.ii1max = 800		# number of changes to dtreal
bbb.ii2max = 5		    # number of timesteps at current dtreal
bbb.itermxrdc = 14#7	    # value of itermx used by rdcontdt
bbb.incpset = 7		    # iterations until Jacobian is recomputed
bbb.ftol_dt = 1.e-5		# fnrm tolerance for the time-dependent steps
bbb.ftol_min = 1e-5 	# value of fnrm where time advance will stop
#bbb.ftol_min = 1e-10        #..zml
bbb.dt_tot = 0.		    # tot time accumulated for run (output, not input)
bbb.t_stop = 1.#100.		# value of dt_tot (sec) where calculation will stop
#bbb.t_stop = 1e-6     #.. zml
...
bbb.itermx = 20   #..zml
bbb.tstor_s = 1e-10		# beginning time for storing solution
bbb.tstor_e = 1e-4		# ending time for storing solution
bbb.n_stor = 3000	    # number of linearly spaced storage points
